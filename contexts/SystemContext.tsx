...
interface SystemContextType {
    ...
    localScrubbing: boolean;
    toggleLocalScrubbing: () => void;
...
export function SystemProvider({ children }: { children: React.ReactNode }) {
    ...
    const [localScrubbing, setLocalScrubbing] = useState(true);

    // ... existing start/stop functions ...

    const toggleLocalScrubbing = useCallback(() => {
        setLocalScrubbing(prev => !prev);
    }, []);
